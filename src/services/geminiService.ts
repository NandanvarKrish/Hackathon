    ...
    return {
      ...
      dialogue: [
        ...
        },
        {
          ...
          speaker: "David",
          speakerRole: "Narrator",
          text: `As we reflect on these concepts, remember that every complex equation is simply nature whispering its secret playbook. What questions will you ask next?`,
          timestampOffset: 25,
          emotion: "thoughtful"
        }
      ]
  ...
  return {
    ...
    dialogue: [
      ...
      },
      {
        ...
        speaker: "Alex",
        speakerRole: "Host & Enthusiast",
        text: `Love that analogy! And remember listeners, if you have any questions right now, just hit that 'Interrupt & Ask' button and we'll dive in with you!`,
        timestampOffset: 30,
        emotion: "thoughtful"
      },
      {
        ...
        speaker: "Jordan",
        speakerRole: "Co-Host & Analyst",
        text: `Let's keep going. Looking at the action items, what's the number one thing everyone needs to practice before the exam?`,
        timestampOffset: 37,
        emotion: "curious"
      },
      {
        ...
        speaker: "Alex",
        speakerRole: "Host & Enthusiast",
        text: `Definitely: "${notes.actionItems[0]?.text || 'Review the core derivations'}". Nail that, and you're in fantastic shape!`,
        timestampOffset: 44,
        emotion: "explaining"
      }
    ]
